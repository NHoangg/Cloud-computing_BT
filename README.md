...
- **Multi-tenant support:** every product and transaction stores a `tenantId`; product, transaction, receipt, and API queries always filter by the active tenant.
...
- **Product management:** tenants can create products with name, price, and description/category.
...
Open <http://localhost:3000>, choose a tenant, then use the navigation bar to manage products or create a sale.
